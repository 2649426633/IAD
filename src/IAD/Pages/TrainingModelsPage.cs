...
namespace IAD.Pages
{
    public class TrainingModelsPage : UserControl
    {
        ...
        private void Build()
        {
            ...
            root.RowStyles.Add(new RowStyle(SizeType.Absolute, 245F)); root.RowStyles.Add(new RowStyle(SizeType.Percent, 100F)); root.RowStyles.Add(new RowStyle(SizeType.Absolute, 190F));
            TableLayoutPanel top = new TableLayoutPanel { Dock = DockStyle.Fill, ColumnCount = 3, RowCount = 1, BackColor = UiTheme.Page };
            top.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 27F)); top.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 27F)); top.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 46F));
            ...
            mid.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 40F)); mid.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 60F));
            TextBox log = new TextBox { Dock = DockStyle.Fill, Multiline = true, ReadOnly = true, ScrollBars = ScrollBars.Vertical, BorderStyle = BorderStyle.None, Font = UiTheme.Font(8.2F, false), Text = "当前任务：TRN-20250516-005 (SegFormer-B2)\r\n进度：Epoch 38 / 100 (38%)\r\n预计剩余：00:42:17\r\n当前学习率：0.000087\r\n最佳验证集 mIoU：0.7421 (Epoch 32)\r\n\r\n[14:41:02] Loss 0.3867  Dice 0.7183  mIoU 0.7112\r\n[14:41:46] Loss 0.3681  Dice 0.7245  mIoU 0.7169\r\n[14:43:15] Validation mIoU 0.7421  Recall 0.7325  Precision 0.7719\r\n[14:43:15] New best model saved." };
            ...
            bottom.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 31F)); bottom.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 69F));
