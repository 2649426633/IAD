...
namespace IAD.Pages
{
    partial class TemplateRecognitionPage
    {
        ...
        private Button btnSearchCandidates;
        ...
        private void InitializeComponent()
        {
            ...
            this.btnSearchCandidates = new Button();
            ...
            this.rootLayout.RowStyles.Add(new RowStyle(SizeType.Absolute,74F));
            ...
            this.fewShotLayout.RowCount = 1;
            this.fewShotLayout.RowStyles.Add(new RowStyle(SizeType.Percent,100F));
            this.fewShotLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute,72F));
            this.fewShotLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent,100F));
            this.fewShotLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute,58F));
            this.fewShotLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute,40F));
            this.fewShotLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute,86F));
            this.fewShotLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute,40F));
            this.fewShotLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute,82F));
            this.fewShotLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute,86F));
            this.fewShotLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute,48F));
            this.fewShotLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute,62F));
            this.lblDefectClassKey.Text = "瑕疵类别";
            this.lblDefectClassKey.Dock = DockStyle.Fill;
            this.lblDefectClassKey.TextAlign = ContentAlignment.MiddleLeft;
            this.cboDefectClass.Items.AddRange(new object[] { "划痕 Scratches", "脏污 Stain", "凹坑 Pit" });
            this.cboDefectClass.SelectedIndex = 0;
            this.cboDefectClass.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            this.lblPositiveKey.Text = "正样本";
            this.lblPositiveKey.Dock = DockStyle.Fill;
            this.lblPositiveKey.TextAlign = ContentAlignment.MiddleRight;
            this.lblPositiveCount.Text = "32";
            this.lblPositiveCount.Dock = DockStyle.Fill;
            this.lblPositiveCount.TextAlign = ContentAlignment.MiddleCenter;
            this.lblHardNegativeKey.Text = "难负样本";
            this.lblHardNegativeKey.Dock = DockStyle.Fill;
            this.lblHardNegativeKey.TextAlign = ContentAlignment.MiddleRight;
            this.lblHardNegativeCount.Text = "128";
            this.lblHardNegativeCount.Dock = DockStyle.Fill;
            this.lblHardNegativeCount.TextAlign = ContentAlignment.MiddleCenter;
            this.lblSimilarityKey.Text = "相似度阈值";
            this.lblSimilarityKey.Dock = DockStyle.Fill;
            this.lblSimilarityKey.TextAlign = ContentAlignment.MiddleRight;
            this.numSimilarity.DecimalPlaces = 2;
            this.numSimilarity.Maximum = 1;
            this.numSimilarity.Value = 0.72M;
            this.numSimilarity.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            this.lblTopKKey.Text = "Top-K";
            this.lblTopKKey.Dock = DockStyle.Fill;
            this.lblTopKKey.TextAlign = ContentAlignment.MiddleRight;
            this.numTopK.Minimum = 1;
            this.numTopK.Maximum = 100;
            this.numTopK.Value = 10;
            this.numTopK.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            ...
            this.btnSearchCandidates.Text = "生成识别候选";
            this.btnMaskRefine.Text = "边缘框精修";
            this.btnConfirm.Text = "人工确认";
            this.btnReject.Text = "人工拒绝";
            this.btnAddHardNegative.Text = "加入Hard Negative";
            this.btnSearchCandidates.Size = new Size(210,28);
            this.btnMaskRefine.Size = new Size(210,28);
            this.btnConfirm.Size = new Size(210,28);
            this.btnReject.Size = new Size(210,28);
            this.btnAddHardNegative.Size = new Size(210,28);
            this.actionPanel.Controls.Add(this.btnSearchCandidates);
            ...
            this.loopLayout.ColumnCount = 2;
            this.loopLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent,58F));
            this.loopLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent,42F));
            this.loopLayout.Dock = DockStyle.Fill;
            this.loopLayout.RowCount = 1;
            this.loopLayout.RowStyles.Add(new RowStyle(SizeType.Percent,100F));
            ...
            this.loopLayout.Controls.Add(this.lblLoopSummary,1,0);
