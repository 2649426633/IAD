...
namespace IAD.Pages
{
    partial class DashboardPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.step1.BorderStyle = BorderStyle.FixedSingle;
            this.step1.Dock = DockStyle.Fill;
            this.step1.Name = "step1";
            this.step1.Text = "1\r\n产品模板建立\r\n已完成\r\n2025-03-01";
            this.step1.TextAlign = ContentAlignment.MiddleCenter;
            this.step2.BorderStyle = BorderStyle.FixedSingle;
            this.step2.Dock = DockStyle.Fill;
            this.step2.Name = "step2";
            this.step2.Text = "2\r\n标注\r\n已完成\r\n2025-03-02";
            this.step2.TextAlign = ContentAlignment.MiddleCenter;
            this.step3.BorderStyle = BorderStyle.FixedSingle;
            this.step3.Dock = DockStyle.Fill;
            this.step3.Name = "step3";
            this.step3.Text = "3\r\n少样本扩标\r\n已完成\r\n2025-03-03";
            this.step3.TextAlign = ContentAlignment.MiddleCenter;
            this.step4.BorderStyle = BorderStyle.FixedSingle;
            this.step4.Dock = DockStyle.Fill;
            this.step4.Name = "step4";
            this.step4.Text = "4\r\n数据质检\r\n已完成\r\n2025-03-04";
            this.step4.TextAlign = ContentAlignment.MiddleCenter;
            this.step5.BackColor = Color.FromArgb(242, 242, 242);
            this.step5.BorderStyle = BorderStyle.FixedSingle;
            this.step5.Dock = DockStyle.Fill;
            this.step5.Font = new Font("Microsoft YaHei UI", 9F, FontStyle.Bold);
            this.step5.Name = "step5";
            this.step5.Text = "5\r\n训练\r\n进行中\r\n当前阶段";
            this.step5.TextAlign = ContentAlignment.MiddleCenter;
            this.step6.BorderStyle = BorderStyle.FixedSingle;
            this.step6.Dock = DockStyle.Fill;
            this.step6.Name = "step6";
            this.step6.Text = "6\r\n验收\r\n待开始";
            this.step6.TextAlign = ContentAlignment.MiddleCenter;
            this.step7.BorderStyle = BorderStyle.FixedSingle;
            this.step7.Dock = DockStyle.Fill;
            this.step7.Name = "step7";
            this.step7.Text = "7\r\n发布\r\n待开始";
            this.step7.TextAlign = ContentAlignment.MiddleCenter;
            this.step8.BorderStyle = BorderStyle.FixedSingle;
            this.step8.Dock = DockStyle.Fill;
            this.step8.Name = "step8";
            this.step8.Text = "8\r\n检测\r\n待开始";
            this.step8.TextAlign = ContentAlignment.MiddleCenter;
            ...
            this.statsLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 20F));
            this.statsLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 20F));
            ConfigureStatGroup(this.grpImages, this.lblImagesValue, this.lblImagesTime, "图片总数", "128,560");
            ConfigureStatGroup(this.grpAnnotated, this.lblAnnotatedValue, this.lblAnnotatedTime, "已标注图片", "98,732");
            ConfigureStatGroup(this.grpDefectClasses, this.lblDefectClassesValue, this.lblDefectClassesTime, "缺陷类别数", "42");
            ConfigureStatGroup(this.grpDefectInstances, this.lblDefectInstancesValue, this.lblDefectInstancesTime, "缺陷实例数", "256,731");
            ConfigureStatGroup(this.grpCandidates, this.lblCandidatesValue, this.lblCandidatesTime, "待确认候选数", "5,362");
            ...
            this.dgvTrainingCol1.HeaderText = "训练批次"; this.dgvTrainingCol1.Name = "dgvTrainingCol1";
            this.dgvTrainingCol2.HeaderText = "模型"; this.dgvTrainingCol2.Name = "dgvTrainingCol2";
            this.dgvTrainingCol3.HeaderText = "数据集"; this.dgvTrainingCol3.Name = "dgvTrainingCol3";
            this.dgvTrainingCol4.HeaderText = "状态"; this.dgvTrainingCol4.Name = "dgvTrainingCol4";
            this.dgvTrainingCol5.HeaderText = "F1"; this.dgvTrainingCol5.Name = "dgvTrainingCol5";
            this.dgvTrainingCol6.HeaderText = "召回率"; this.dgvTrainingCol6.Name = "dgvTrainingCol6";
            this.dgvTrainingCol7.HeaderText = "日期"; this.dgvTrainingCol7.Name = "dgvTrainingCol7";
            ...
            this.dgvInspectionCol4.HeaderText = "检测数"; this.dgvInspectionCol4.Name = "dgvInspectionCol4";
            this.dgvInspectionCol5.HeaderText = "NG数"; this.dgvInspectionCol5.Name = "dgvInspectionCol5";
            this.dgvInspectionCol6.HeaderText = "NG率"; this.dgvInspectionCol6.Name = "dgvInspectionCol6";
            this.dgvInspectionCol7.HeaderText = "时间"; this.dgvInspectionCol7.Name = "dgvInspectionCol7";
        ...
        private void ConfigureStatGroup(GroupBox group, Label value, Label time, string title, string number)
        {
            group.Dock = DockStyle.Fill;
            group.Text = title;
            value.Dock = DockStyle.Fill;
            value.Font = new Font("Microsoft YaHei UI", 18F);
            value.Text = number;
            value.TextAlign = ContentAlignment.MiddleCenter;
            time.Dock = DockStyle.Bottom;
            time.Height = 24;
            time.Text = "数据截止：2025-05-16 24:00";
            time.TextAlign = ContentAlignment.MiddleCenter;
            group.Controls.Add(value);
            group.Controls.Add(time);
        }
    }
}
